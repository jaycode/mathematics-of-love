 ...
 * With some adjustments by Jaycode:
 *   - onNext and onPrev will now not trigger page change, this is to acco-
 *     modate page change after some animation / ajax loading completed.
 * find out where the changes are.
    ...
    Tour.prototype.showStep = function(i) {
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          _this._debug("onNext is " + step.onNext.toString() + " fromGoTo is " + _this._fromGoTo);
          if (_this._fromStart == true || 
            _this._fromGoTo == true || 
            (
              _this._fromNext && _this.getStep(step.prev).onNext.toString() == 'function (tour) {}' ||
              _this._fromPrev && _this.getStep(step.next).onPrev.toString() == 'function (tour) {}'
            )
          ) {
            _this._fromNext = false;
            _this._fromPrev = false;
            _this._fromStart = false;
            _this._fromGoTo = false;
          ...
          if (_this._isOrphan(step)) {
            if (!step.orphan) {
              ...
              if (skipToPrevious) {
                ...
                _this._debug("Showing next step");
                _this._showNextStep();
              }
              return;
            }
      ...
      if (step.delay) {
        ...
        this._debug('about to _callOnPromiseDone');
